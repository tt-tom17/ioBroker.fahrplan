...
export default class fDepTT{
	...
	* @typedef {import('./options').default} fOptions
	...
	async getDepTT(DepTTOptions){
		...
		try{
			...
			if (e.hafasErrorCode === "H890"){
				...
				this.helper.ReportingError(e, `HAFAS error in Departure Timetable`, "fDepTT", "getDepTT", "", {hafas: {request: e.request, url: e.url, statusCode: e.statusCode, code: e.code, responseId: e.responseId} });
