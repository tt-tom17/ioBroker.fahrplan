	...
	async getRoute(RouteOptions){
		...
		try{
			...
			if (e.hafasErrorCode === "H890"){
				...
				this.helper.ReportingError(e, `HAFAS error in Route`, "fRoute", "getRoute", "", {hafas: {request: e.request, url: e.url, statusCode: e.statusCode, code: e.code, responseId: e.responseId} });
