...
import fJourney from "./journey.js";
...
const sRouteHTMLHeader2 = {
	...
	"zh-cn":
		'<tr><th align="center">离开</th><th align="center">延迟</th><th align="center">到达</th><th align="center">延迟</th></tr>',
};
const sRouteHTMLHeader3 = {
	...
	"zh-cn":
		'<tr><th align="center">离开</th><th align="center">延迟</th><th align="center">平台</th><th align="center">到达</th><th align="center">延迟</th><th align="center">平台</th></tr>',
};
const sRouteHTMLHeader4 = {
	en: '<tr><th align="center">Departure</th><th align="center">Delay</th><th align="center">Platform</th><th align="center">Arrival</th><th align="center">Delay</th><th align="center">Platform</th><th align="center">Line</th></tr>',
	de: '<tr><th align="center">Abfahrt</th><th align="center">Verspätung</th><th align="center">Plattform</th><th align="center">Ankunft</th><th align="center">Verspätung</th><th align="center">Plattform</th><th align="center">Line</th></tr>',
	ru: '<tr><th align="center">Вылет из</th><th align="center">задержка</th><th align="center">Платформа</th><th align="center">Прибытие</th><th align="center">задержка</th><th align="center">Платформа</th><th align="center">Линия</th></tr>',
	pt: '<tr><th align="center">Saída</th><th align="center">Demora</th><th align="center">Plataforma</th><th align="center">Chegada</th><th align="center">Demora</th><th align="center">Plataforma</th><th align="center">Line</th></tr>',
	nl: '<tr><th align="center">Vertrek</th><th align="center">Vertraging</th><th align="center">Platform</th><th align="center">Aankomst</th><th align="center">Vertraging</th><th align="center">Platform</th><th align="center">Line</th></tr>',
	fr: '<tr><th align="center">Départ</th><th align="center">Retard</th><th align="center">Plate-forme</th><th align="center">Arrivée</th><th align="center">Retard</th><th align="center">Plate-forme</th><th align="center">Line</th></tr>',
	it: '<tr><th align="center">Partenza</th><th align="center">Ritardo</th><th align="center">piattaforma</th><th align="center">Arrivo</th><th align="center">Ritardo</th><th align="center">piattaforma</th><th align="center">Linea</th></tr>',
	es: '<tr><th align="center">Salida</th><th align="center">Retrasar</th><th align="center">Plataforma</th><th align="center">Llegada</th><th align="center">Retrasar</th><th align="center">Plataforma</th><th align="center">Línea</th></tr>',
	pl: '<tr><th align="center">wyjazd</th><th align="center">Opóźnienie</th><th align="center">Platforma</th><th align="center">Przyjazd</th><th align="center">Opóźnienie</th><th align="center">Platforma</th><th align="center">Linia</th></tr>',
	"zh-cn":
		'<tr><th align="center">离开</th><th align="center">延迟</th><th align="center">平台</th><th align="center">到达</th><th align="center">延迟</th><th align="center">平台</th><th align="center">线路</th></tr>',
};

export default class fRoute {
	constructor(helper) {
		this.helper = helper;
		...
		try {
			if (this.enabled === true) {
				await this.helper.SetChannel(
					this.index.toString(),
					`Route #${this.index.toString()} - ${this.StationFrom.name} - ${this.StationTo.name}`,
					"Route from Adapter configuration",
				);
			}
			await this.helper.SetBoolState(
				`${this.index.toString()}.Enabled`,
				`Configuration State of Route #${this.index.toString()}`,
	...
	async writeStates() {
		try {
			for (const iJourneysCurrent in this.Journeys) {
				await this.Journeys[iJourneysCurrent].writeJourney(
					`${this.index}.${iJourneysCurrent}`,
					this.index,
					iJourneysCurrent,
				);
			}
				...
				if (this.helper.Fahrplan.config.CreateHTMLHeadlines === 1) {
					switch (this.helper.Fahrplan.config.CreateHTML) {
						...
						case 3:
							...
							break;
						case 4:
							this.html = `${this.html}${sRouteHTMLHeader4[this.helper.Fahrplan.SysLang]}`;
							break;
						default:
	 ...
	 *
	 * @param RouteOptions Single configuration entry for route
	 */
	async getRoute(RouteOptions) {
		...
		try {
			this.helper.ReportingInfo(
				"Debug",
				"Route",
				`Executing HAFAS search for Route #${this.index.toString()}`,
				"fRoute",
				"getRoute",
				"RouteSearch",
				JSON.stringify(RouteOptions.returnRouteOptions()),
			);
			aRouteResult = await this.helper.hClient.journeys(
				this.StationFrom.id.toString(),
				this.StationTo.id.toString(),
				RouteOptions.returnRouteOptions(),
			);
			this.json = JSON.stringify(aRouteResult);
			this.helper.ReportingInfo(
				"Debug",
				"Route",
				`Result received for Route #${this.index.toString()}: ${JSON.stringify(aRouteResult)}`,
				"fRoute",
				"getRoute",
				"RouteSearch",
				JSON.stringify(aRouteResult),
			);
			if (this.helper.Fahrplan.config.SaveJSON !== false) {
				await this.helper.SetTextState(
					`${this.index.toString()}.JSON`,
					"Route JSON",
					"Route JSON",
					JSON.stringify(aRouteResult),
					"json",
			...
			if (e.hafasErrorCode === "H890") {
				...
				e.message === "HAFAS Kernel: No connection found after post filtering" ||
				e.message === "HCI Core: Invalid client version"
			) {
				this.helper.Fahrplan.log.error(`Connection error to HAFAS (${e.message})`);
				this.JourneysFound = false;
			} else if (e.isHafasError === true) {
				this.helper.ReportingError(e, `HAFAS error in Route`, "fRoute", "getRoute", "", {
					hafas: {
						request: e.request,
						url: e.url,
				...
				for (const iJourneysCurrent in aRouteResult.journeys) {
					if (parseInt(iJourneysCurrent) < this.NumDeps) {
						...
						this.helper.ReportingInfo(
							"Debug",
							"Route",
							`Route #${this.index.toString()} running on Journey #${iJourneysCurrent}: ${JSON.stringify(aConn)}`,
							"fRoute",
							"getRoute",
							"Iteration",
							JSON.stringify(aConn),
						);
